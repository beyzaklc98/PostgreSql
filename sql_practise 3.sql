...
-- 101 id öğrencinin ismini 'LEO OCEAN' olarak güncelleyin
update students set student_name='LEO OCEAN' where student_id='101';

-- 101 id öğrencinin ismini 'ALI CAN' olarak güncelleyin
...
select * from students order by yas desc limit 3 offset 3;
