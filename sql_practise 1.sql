...
select * from personel where email not like '%@gmail.com'; -- % ile arama yaptıgımız icin null gelmez
...
select * from personel order by yas; -- dogal sıralama kucukten buyuge dogru asc
